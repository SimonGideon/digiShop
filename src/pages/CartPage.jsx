...
const CartPage = () => {
  ...
  return (
    <div className="p-8">
      <div className="bg-white p-5 rounded-lg shadow-md flex flex-col md:flex-row">
                ...
                <tr>
                  <td className="p-4 border-r">
                    <div className="flex items-center">
                      ...
                      />
                      <span>OnePlus Nord CE 4 8gb 256gb</span>
                    </div>
                  </td>
                  <td className="p-4 border-r">KSh38,499.00</td>
                  ...
                  <td className="p-4">KSh{subtotal.toLocaleString()}.00</td>
                  <td className="p-4">
        ...
        <div className="mt-8 md:mt-0 md:ml-8 bg-gray-100 p-6 rounded-lg w-full md:w-1/3">
